...
class PanchangSerializer(serializers.Serializer):
    ...
    karana_1 = serializers.CharField()
    karana_2 = serializers.CharField()
    karana_1_range = serializers.CharField()
    karana_2_range = serializers.CharField()
    ...
    moon_rashi = serializers.CharField()
    sun_rashi = serializers.CharField()
